...
import com.example.levelty.presenter.ui.kid.KidSetGoalFragment
...
interface AppComponent {
    ...
    fun kidEarnCoinsDialogInject(kidEarnCoinsDialog: KidEarnCoinsDialog)
    fun kidSetGoalFragmentInject(kidSetGoalFragment: KidSetGoalFragment)
