...
import com.example.levelty.domain.usecases.GetKidsInterestChooseUseCase
...
class KidsInterestChooseFragmentViewModelFactory @Inject constructor(
    private val getKidsInterestChooseUseCase: GetKidsInterestChooseUseCase): ViewModelProvider.Factory {
