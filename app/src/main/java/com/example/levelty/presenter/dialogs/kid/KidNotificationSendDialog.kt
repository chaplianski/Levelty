...
import com.example.levelty.databinding.FragmentKidNotificationSendDialogBinding
...
class KidNotificationSendDialog : DialogFragment() {
    ...
    var _binding: FragmentKidNotificationSendDialogBinding? = null
...
//        activity?.window?.statusBarColor = Color.TRANSPARENT
        ...
        _binding = FragmentKidNotificationSendDialogBinding.inflate(layoutInflater, container, false)
            return binding.root
    }
